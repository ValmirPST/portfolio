    ...
    <section className="projects-container">
      <article className="project-box">
        ...
        <a
          ...
          href="https://valmirpst.github.io/android-project"
          target="_blank"
          rel="noreferrer"
        >
          <img className="project-image" src={project01} alt="" />
        </a>
      ...
      <article className="project-box">
        ...
        <a
          className="project-link"
          href="https://valmirpst.github.io/online-to-do"
          target="_blank"
          rel="noreferrer"
        >
          <img className="project-image" src={project02} alt="" />
        </a>
      ...
      <article className="project-box">
        ...
        <a
          className="project-link"
          href="https://valmirpst.github.io/usual-exercises"
          target="_blank"
          rel="noreferrer"
        >
          <img className="project-image" src={project03} alt="" />
        </a>
